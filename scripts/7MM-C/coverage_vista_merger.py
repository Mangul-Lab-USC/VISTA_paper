...
#AUTHOR: SEUNGMO LEE
def merge_vcfs(input_files, output_file, tool1, tool2, tool3, tool4):
    merged_records = []
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python human_merger.py outputfile_name tool1 tool2 tool3 tool4 vcf1.vcf vcf2.vcf ... vcf10.vcf \n Input more than one, and it has to contain tools")
    else:
        ...
        merge_vcfs(input_files, output_file, tool1, tool2, tool3, tool4)
